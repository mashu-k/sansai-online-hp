...
export const metadata = {
  title: "PRINT HARVEST Vol.01 — ネパール・ヒマラヤ遠征 限定Tシャツ",
  description:
    "山菜採りオンライン PRINT HARVEST Vol.01。クライマー・テツのネパール・ヒマラヤ遠征から持ち帰る一枚の写真が、そのまま限定Tシャツになる。Tシャツ＋現地撮影ポストカードのセット。受注締切2026年8月下旬、価格12,500円（送料込み）。売上は遠征の撮影費に充てられます。",
  openGraph: {
    title: "PRINT HARVEST Vol.01 — 山から、持ち帰る。",
    description:
